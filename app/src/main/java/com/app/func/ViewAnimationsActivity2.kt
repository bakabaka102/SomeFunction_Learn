...
import com.app.func.navigation.BubbleAnimation
import com.app.func.navigation.BubbleEmitterAnimation
...
class ViewAnimationsActivity2 : BaseActivity<ActivityViewAnimations2Binding>() {
    ...
    private fun initNavigation() {
        ...
        navController.graph = navController.createGraph(
            ...
            fragment<BubbleEmitterFragment, BubbleEmitterAnimation> {
